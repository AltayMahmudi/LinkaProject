        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(maxLength: 59, nullable: false),
                    Email = table.Column<string>(maxLength: 59, nullable: false),
                    Password = table.Column<string>(maxLength: 100, nullable: false),
                    Token = table.Column<string>(maxLength: 59, nullable: true),
                    ForgetToken = table.Column<string>(maxLength: 59, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedBy = table.Column<string>(maxLength: 50, nullable: true),
                    ModifiedBy = table.Column<string>(maxLength: 50, nullable: true),
                    İd = table.Column<int>(nullable: false),
                    Name = table.Column<string>(maxLength: 100, nullable: false),
                    SKU = table.Column<string>(maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInspiration = table.Column<bool>(nullable: false),
                    IsBanner = table.Column<bool>(nullable: false),
                    IsLatest = table.Column<bool>(nullable: false),
                    IsEditorsChoice = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Review = table.Column<string>(maxLength: 1500, nullable: false),
